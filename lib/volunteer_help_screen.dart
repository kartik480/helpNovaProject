...
class VolunteerHelpScreen extends StatefulWidget {
  const VolunteerHelpScreen({super.key});

  @override
  State<VolunteerHelpScreen> createState() => _VolunteerHelpScreenState();
}

class _VolunteerHelpScreenState extends State<VolunteerHelpScreen> {
  ...
  Future<void> _submitRequest() async {
    ...
    if (_selectedHelpType == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Please select help type')),
      );
      return;
    }
    ...
    try {
      // Call API to submit volunteer request
      final result = await ApiService.submitVolunteerRequest(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  Text('Your volunteer help request has been submitted successfully!'),
                  SizedBox(height: 10),
                  Text('Nearby volunteers get notified.'),
                ],
              ),
              actions: [
                TextButton(
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: _helpTypes.map((String type) {
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Please select help type';
                    }
                    return null;
                  },
                ),
